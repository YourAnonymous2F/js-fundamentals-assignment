...
// Creating variables to store my personal information and display them in formatted string. Requirements : Use const for values that won't change

const myFullName = "Fohdilulahi Olayanju";
